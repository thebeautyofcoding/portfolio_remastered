...
function SocialMedia() {
  return (
    <div className="shadow p-2 rounded flex flex-col bg-gray-200 glass-background glowing-shadow">
      <div className="text-white hover:text-blue-500 transition duration-300 cursor-pointer">
        <a href="https://github.com/thebeautyofcoding">
          {" "}
          <AiFillGithub size={38} />
        </a>
      </div>
      <div className="text-white hover:text-blue-500 transition duration-300 cursor-pointer my-4">
